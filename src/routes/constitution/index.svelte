...
<div class="constitution">
    <h1 class="noUnderscore">LATE INTERCEPTION LEAGUE CONSTITUTION</h1>
    ...
    <p>2 IR Spots (Player must be labeled as IR, Out, or Covid in the Sleeper App)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                <tr><td>QB</td><td class="right">2 active, 4 total</td></tr>
                <tr><td>RB</td><td class="right">6</td></tr>
                <tr><td>WR</td><td class="right">6</td></tr>
                <tr><td>TE</td><td class="right">3</td></tr>
                <tr><td>DEF</td><td class="right">3</td></tr>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>First Offense – Immediate reversal of the trade.</li>
    ...
    <div class="subBlock">
        <p>You will not be able to trade draft picks that are more than 2 drafts away. For example, during the 2022 season you cannot trade any picks in or after the 2024 draft.</p>
    </div>
    ...
    <p>Players clears waivers after Tuesdays.</p>
    ...
    <p>League dues are set at $50. Dues are collected through <a href="https://leaguesafe.com/join/4052658">LeagueSafe</a> and collection will be sent out no later than August 26, 2022. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
    
    <h3 bind:this={sevenTwo}>7.2 Payout</h3>
    <p>League payout is structured as follows:</p>
    <ul>
        <li>First Place: $240</li>
	<li>Second Place: $120</li>
        <li>Third Place: $60</li>
        <li>Highest Regular Season Points: $120</li>
        <li>Highest Score of the Season: $60</li>
    </ul>
